...
manager = Actualize::Manager.new(first_name: "Calvin", last_name: "Bartholow", salary: 90000, active: true, employees: [employee1, employee2])
manager.print_info
...
intern = Actualize::Intern.new(first_name: "Krunal", last_name: "Patel", salary: 20000, active: true)
intern.print_info
